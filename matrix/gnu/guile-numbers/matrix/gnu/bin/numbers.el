...
;; name project: guile-numbers
;; name program: numbers
;; func program: value-list
;; notice: glob news
;; form: liders
;; gnu hack: GNU Guile Numbers (GNU Emacs Numbers Reference Manual)

;; buffer list: full-way
;; name list: way
;; argument: args
...
;; commit easy level psiw! shcemes

#b000101

;; running value list easy board

#b111111

;; return value list easy board

#b111011

;; gnu positive documentation append list

most-positive-fixnum

;; gnu negative documentation append list

most-negative-fixnum

;; gnu integer documentation append list

integer-width

;; gnu isnan documentation append list x

(let* (isnan x)
  integer-width)

;; gnu frexp documenation append edge list

(let* (frexp x))

;; gnu ldexp s e documentation append list

(let* (ldexp s e)
  integer-width)

;; gnu copysign x1 x2 documentation copy list

(let* (copysign x1 x2)
  integer-width)

;; gnu logb value documentation append list

(let* (logb ARG)
  integer-width)

;; gnu bignump object documenation append list

(let* (bignump OBJECT)
  integer-width)

;; gnu fixnump object documenation append list

(let* (fixnump OBJECT)
  integer-wdith)

;; gnu floatp object documenation append list

(let* (floatp OBJECT)
  integer-width)


;; gnu numberp object documenation append list

(let* (numberp OBJECT)
  integer-width)

;; gnu natnump object documenation append list

(let* (natnump OBJECT)
  integer-width)

;; gnu zerop number documentation append list
