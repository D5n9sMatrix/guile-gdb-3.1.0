...
;; STYLE: group-marks
;; NEWS: cbs news
;; MONEY: nuclear production to all humanity
;; GETTERS: money feature
;; SELECTOR: templates

;; STYLE ORDER: way-one
;; FOOT BOOL: atack
;; CAT INFO:. files view
;; RAF MSG: message friends
;; DOG INFO: latters
;; DEVELOP: green bull
;; @SKILL: radios and cbs news
;; @EQUIP: discord friends
;; @COMMUNITY: discrod friends
;; PYTHON:. angles support nay
;; GNU: GNU Guile input Manual
;; PORT: address

;; BORTH: enjoy
;; TOOLS: drill
;; GASS:. start boot buffer
;; URL: http://gnu.org
;; DISCRUSOR: friends and next context
;; RELATION: friends
;; MATRIX: connect
;; OBJECTIVE: build's documentaion guides

;; START TALK
;; LOADING ...

(progn (print1 'foo ) (princ "\n") (prin1 'bar))
